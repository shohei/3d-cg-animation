...
//  rigid[0].kind = "CYLINDER";
  ...
  floor0.vPos = new Vector3(0.0, 0.0, -plane[2]-0.01);
...
{  
  ...
  if(selectNo == 0) { rigid[0].flagTexture = true; rigid[1].flagTexture = false;}
  else { rigid[1].flagTexture = true; rigid[0].flagTexture = false;}
}
