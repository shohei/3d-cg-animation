...
var repeatS = 1;
var repeatT = 1;
var inverse = 1;//-1で凹凸反転
var mode = 0;//合成モード(0:変調，1:混合）
var mixK = 0.5;//混合モードのときの混合係数
var flagDisable = false;//バンプマッピングの無効化
//animation
var fps = 0;
...
function initBumpMap() 
{
  ...
  //image.src = '../imageJPEG/matumae.jpg';
...
{  
  ...
  var disableLoc = gl.getUniformLocation(gl.program, 'u_flagDisable');
  gl.uniform1i(disableLoc, flagDisable);
...
{
  if(form2.disable.checked) flagDisable = true;
  else                      flagDisable = false;
  display();
}
