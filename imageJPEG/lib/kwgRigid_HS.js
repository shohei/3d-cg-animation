...
Rigid_HS.prototype.initVertexBuffers = function(gl)
{
  ...
  if     (this.kind == "CUBE") nLength = makeCube(vertices, normals, indices, this.flagSolid);
  else if(this.kind == "SPHERE") nLength = makeSphere(vertices, normals, indices, this.nSlice, this.nStack);
  else if(this.kind == "CYLINDER")nLength =  makeCylinder(vertices, normals, indices, this.radiusRatio, this.nSlice, this.flagSolid);
  else if(this.kind == "PRISM") nLength = makePrism(vertices, normals, indices, this.radiusRatio, this.nSlice, this.flagSolid);
  ...
  else if(this.kind == "CYLINDER_Z") nLength = makeCylinderZ(vertices, normals, indices, this.nSlice, this.flagSolid);
